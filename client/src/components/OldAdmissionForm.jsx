...
export default function OldAdmissionForm() {
    ...
    useEffect(() => {
        ...
        handleChange()
    }, [name, sid, email, mobile, father, guardian, gender,
        admissionDate, shift, time, paymentAmount, seatNumber, seatShift,
        address, compressImage, userId])
                    ...
                    <div className='bg-white shadow-lg rounded-md'>
                        <form onSubmit={handleSubmit} encType='multipart/form-data' className='p-4'>
                            <div>
                                ...
                                <input required className="p-2 border rounded-md w-full" value={sid} onChange={(e) => setSid(e.target.value)} type="text" id="name" placeholder="Enter Your Old Sid" />
                            </div>
