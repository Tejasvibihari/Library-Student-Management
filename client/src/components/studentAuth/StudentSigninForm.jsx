...
import { signInFailure, signInStart, signInSuccess } from '../../models/student/studentAuthSlice';
            ...
            <div className='bg-gray-200 h-screen'>
                <div className='p-10'>
                    ...
                    <div className='border rounded-md max-w-md md:max-w-sm mx-auto p-7 bg-white'>
                        <h3 className='mt-7 text-[#1b2c3f] text-center font-bold text-xl'>Student Sign In</h3>
