            ...
            <div className='border shadow-md rounded-md w-full hello'>
                <div className='text-white p-4'>
                    <div className='flex flex-col md:flex-row justify-between items-center'>
                        {/* Proile Image  */}
                        <div>
                            {/* <img src={`https://api.biharilibrary.in/uploads/${src}`} className='w-32 rounded-full shadow-sm shadow-white border' /> */}
                        ...
                        <div className='mx-1'>
                            <Link to={`/student-admin-dashboard/${studentId}`}>
                                <button className='p-2 w-full  rounded-md flex justify-center items-center text-white bg-[#8e54e9] hover:bg-[#8e54e9e6]'>
                                    <ReceiptText size={17} className='mr-2' />Delete Student
                                </button>
                            </Link>
                        </div>
                        <div className='mx-1'>
